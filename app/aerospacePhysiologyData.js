...
// Based on T6_AP_SG_Mar21.pdf - Sample of Behaviors
// 135 Multiple Choice Questions - 100% SOB Coverage

export const aerospacePhysiologyTopics = {
  introduction_atmosphere: "Introduction and Atmosphere",
  respiration_circulation: "Respiration and Circulation",
  altitude_threats: "Altitude Threats",
  cabin_pressurization: "Cabin Pressurization",
  vision: "Vision",
  night_vision_sa: "Night Vision and Situational Awareness",
  spatial_disorientation: "Spatial Disorientation",
  noise_vibration: "Noise and Vibration",
  acceleration: "Acceleration",
  performance_threats: "Performance Threats Management",
...
export const aerospacePhysiologyQuestions = {
  multipleChoice: [
    // AP101 - Introduction and Atmosphere Questions
    {
      ...
      difficulty: "medium",
      question:
        "During a rapid decompression at FL350, you notice a sealed water bottle in the cockpit has expanded significantly. Which gas law explains this phenomenon?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What is the correct notation for the partial pressure of oxygen in the lungs?",
      options: [
        "PPO₂ notation",
        "PO₂ notation",
        "psi O₂ units",
      ...
      correctAnswer: 1,
      explanation:
        "The correct notation for partial pressure of oxygen is PO₂. Similarly, PCO₂ represents partial pressure of carbon dioxide and PN₂ represents partial pressure of nitrogen. Dalton's Law of Partial Pressure explains how the total atmospheric pressure equals the sum of all these partial pressures.",
      limitation: false,
      objectiveType: "identify",
...

    {
      ...
      difficulty: "medium",
      question:
        "If the temperature at sea level is 30°C, what would the approximate temperature be at 20,000 feet MSL using the standard temperature lapse rate?",
      options: ["0°C temp", "-10°C temp", "-20°C temp", "-30°C temp"],
      correctAnswer: 1,
      explanation:
        "The standard temperature lapse rate is approximately 2°C per 1,000 feet. At 20,000 feet, the temperature change would be 40°C (20 × 2°C). Starting at 30°C and decreasing by 40°C gives us -10°C. This lapse rate applies up to approximately 35,000 feet.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
        "Recognize the definition of the standard temperature lapse rate",
    },

    {
      ...
      difficulty: "high",
      question:
        "At what altitude does the physiological deficient zone begin, requiring supplemental oxygen for normal function?",
      options: ["5,000 feet", "10,000 feet", "18,000 feet", "25,000 feet"],
      correctAnswer: 1,
      explanation:
        "The physiological deficient zone begins at approximately 10,000 feet MSL. Below this altitude is the physiological zone where the human body is naturally adapted. Above 10,000 feet, the reduced atmospheric pressure means inadequate oxygen partial pressure to sustain normal physiologic functions, requiring supplemental oxygen use.",
      limitation: false,
      objectiveType: "list",
    ...
    // AP102 - Respiration and Circulation Questions
    {
      ...
      difficulty: "medium",
      question:
        "What are the five distinct phases of respiration in the correct order?",
      options: [
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "The arterial partial pressure of carbon dioxide (PaCO₂) is the most important factor in controlling ventilation under normal conditions. The sensitivity is remarkable - PaCO₂ is normally held within 3 mmHg of 45 mmHg during daily activities. Hyperventilation can reduce PaCO₂ and eliminate the breathing urge temporarily.",
      limitation: false,
      objectiveType: "identify",
...

    {
      ...
      correctAnswer: 2,
      explanation:
        "Gas exchange between the respiratory and circulatory systems occurs at the alveolar-capillary interface. The alveoli are tiny air sacs with walls that have an excellent blood supply from capillaries. Oxygen and carbon dioxide move between air and blood by simple diffusion according to the Law of Gaseous Diffusion.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Identify structures that are important to respiration",
    },

    {
      ...
      options: [
        "Fight infections throughout bloodstream",
        "Transport oxygen via hemoglobin molecules",
        "Regulate blood pressure systemically",
        "Produce carbon dioxide for respiration",
      ],
      correctAnswer: 1,
      explanation:
        "The primary function of red blood cells (RBCs) is to transport oxygen and CO₂. Each RBC contains up to 300 million hemoglobin molecules, giving them substantial oxygen-carrying capacity. Although hemoglobin can carry CO₂, its main function is oxygen transport.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
        "Recall functions of the structures of the circulatory system",
    },

    {
      ...
      correctAnswer: 2,
      explanation:
        "Three main aviation-related factors affect oxygen delivery: (1) Altitude - increases hypoxic hypoxia by reducing PO₂, (2) G-forces - cause blood pooling leading to stagnant hypoxia, and (3) Toxic gases/substances - cause hypemic hypoxia (reduced oxygen carrying capacity) or histotoxic hypoxia (inability to use oxygen). These effects are cumulative.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Identify factors affecting oxygen delivery to the tissues",
    },
...

    {
      ...
      correctAnswer: 2,
      explanation:
        "The pilot experiences both hypoxic hypoxia (from oxygen equipment failure reducing PO₂ in the lungs) and hypemic hypoxia (from smoking, which increases carbon monoxide in the bloodstream). CO has an affinity for hemoglobin 200-250 times greater than oxygen, reducing oxygen-carrying capacity. Smoking prior to flight raises physiological altitude and increases susceptibility to hypoxic hypoxia.",
      limitation: false,
      objectiveType: "identify",
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "Symptoms are warning signals you personally feel or sense: air hunger, headache, lightheadedness, tingling in extremities, dizziness, fatigue, hot/cold flashes, apprehension, and nausea. Signs are observable by others: cyanosis, degraded reaction time, euphoria, belligerence, impaired judgment, increased respiration, muscle incoordination, and unconsciousness. Recognizing your own symptoms is critical for self-rescue.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Identify the signs and symptoms of hypoxic hypoxia onset",
    },
...

    {
      ...
      correctAnswer: 2,
      explanation:
        "All physiological symptoms are treated the same because hypoxia, hypocapnia, toxic exposure, hypoglycemia, and dehydration have very similar symptoms that may be confused or occur simultaneously. In an emergency environment, time should not be wasted attempting to distinguish causes. Following BOLDFACE procedures provides oxygen and restores normal breathing, treating all conditions simultaneously without delay. The most dangerous is hypoxia.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
        "Recall the similarities of treatment for hypocapnia, hypoxia, and other physiological symptoms",
    },

    {
      ...
      correctAnswer: 2,
      explanation:
        "While gas expands during ascent, trapped gas problems occur more often during descent when the pressure differential prevents equalization. For example, the Eustachian tube acts like a one-way flapper valve - gas vents easily during ascent, but ambient pressure forces the eardrum inward during descent and you must assist equalization. If pressure differential exceeds 80 mmHg, an ear block can occur.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
...

    {
      ...
      objectiveType: "memorize",
      learningObjective:
        "Memorize how to treat and prevent trapped gas disorders",
    },
...

    {
      ...
      difficulty: "critical",
      question:
        "A crewmember at altitude experiences deep, sharp pain under the sternum, dry cough, and difficulty with inspiration. What type of DCS is this?",
      options: [
        "The Bends causing joint pain",
        "The Chokes causing pulmonary symptoms",
        "CNS manifestations causing neurological symptoms",
        "The Creeps causing skin symptoms",
      ],
      correctAnswer: 1,
      explanation:
        "These are symptoms of 'The Chokes' - a rare but potentially dangerous type of DCS affecting the lungs. Symptoms include deep sharp pain centrally located under the sternum, dry nonproductive cough, difficulty with inspiration, and sense of suffocation. Immediate descent is necessary and post-flight shock is possible. These symptoms are similar to a heart attack and may be misdiagnosed.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Identify the symptoms associated with each type of decompression sickness",
    },

    {
      ...
      difficulty: "high",
      question:
        "What is the threshold altitude where decompression sickness incidence abruptly increases without pre-oxygenation?",
      options: [
        "10,000 feet MSL",
        "18,000 feet MSL",
        "21,200 feet MSL",
    ...
    // AP104 - Cabin Pressurization Questions
    {
      ...
      correctAnswer: 1,
      explanation:
        "Cabin pressurization provides the most effective method of protection from hostile high altitude environments by minimizing the hazards of decompression sickness, hypoxia, and fatigue. Pressurization systems maintain increased pressure in the cabin by pumping pressurized, conditioned air from the jet engine compressor, keeping the cabin altitude low even when flying at high altitude.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
        "Recall the advantages and disadvantages of pressurization systems",
    },

    {
      ...
      difficulty: "critical",
      question:
        "What are the physical indications that you would experience during a rapid decompression?",
      options: [
        "Sudden fog, loud noise, flying debris, and rapid temp increase",
        "Gradual pressure decrease, slow temp drop, and mild discomfort",
        "Loud noise, sudden fog/mist, flying debris, rapid temp decrease, and possible ear/sinus pain",
        "Only a warning light illuminating on the instrument panel",
      ],
      correctAnswer: 2,
      explanation:
        "During rapid decompression, you would experience: loud noise (explosive or rush of air), sudden fog/mist in cabin (from condensation of water vapor), flying debris, rapid temperature decrease (air expanding and cooling), and possible pain in ears/sinuses from pressure differential. Immediate recognition and response is critical given the reduced TUC that occurs with rapid decompression.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Identify the physical indications of rapid decompression",
    },

    {
      ...
      difficulty: "medium",
      question:
        "What distinguishes a rapid decompression from a slow decompression?",
      options: [
        "Rapid occurs above 25,000 ft; slow occurs below 25,000 ft altitude",
        "Rapid occurs so fast lungs decompress before exhaling; slow allows lungs to decompress during normal breathing",
        "Rapid always causes immediate unconsciousness; slow does not cause it",
        "There is no practical difference between the two types of decompression",
      ],
      correctAnswer: 1,
      explanation:
        "A rapid decompression occurs so quickly that the lungs decompress faster than air can be exhaled - this can reduce TUC by up to 50%. In a slow/gradual decompression, the cabin altitude gradually increases and the lungs can decompress during normal breathing. Slow decompressions are insidious because hypoxia has slow onset and symptoms may be well developed before recognition.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
    ...
    // AP105 - Vision Questions
    {
      ...
      objectiveType: "memorize",
      learningObjective:
        "Memorize the function of each part of the eye discussed",
    },

    {
      ...
      correctAnswer: 1,
      explanation:
        "The physiological blind spot exists where the optic nerve exits the back of the eye. At this point, there are no photoreceptors (rods or cones) to detect light. Normally, you don't notice this because your brain fills in the gap and your other eye covers the area. However, this emphasizes the importance of proper scanning to avoid missing aircraft in this blind zone.",
      limitation: false,
      objectiveType: "recognize",
      learningObjective:
        "Recognize the physiological blind zones associated with parts of the eye",
    },

    {
      ...
      difficulty: "critical",
      question:
        "What is the correct scanning technique to avoid midair collisions?",
      options: [
        "Continuously sweep your eyes across entire sky in one smooth motion",
        "Focus directly ahead and use peripheral vision for other aircraft",
        "Systematically scan sky in sectors, pausing to focus on each 10-15 degree segment for 1-2 sec",
        "Look only where you expect other aircraft to be located",
      ],
      correctAnswer: 2,
      explanation:
        "Proper scanning involves systematically scanning the sky in sectors, focusing on each 10-15 degree segment for 1-2 seconds before moving to the next. This allows your focal vision (fovea) time to detect objects. Smooth continuous sweeping doesn't allow time for the eyes to focus. Empty-field myopia and other factors make it critical to use proper scanning technique with short eye movements and pauses.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Identify the correct scanning technique used to avoid midair collisions",
    },

    {
      ...
      correctAnswer: 1,
      explanation:
        "Empty-field myopia occurs when viewing a featureless field (like clear sky or haze). The eyes automatically relax and focus at approximately 10-30 feet, making distant objects (like other aircraft) appear blurry even though they're within visual range. This is dangerous because you may not detect other aircraft even when looking in their direction. Proper scanning helps overcome this.",
      limitation: false,
      objectiveType: "recognize",
      learningObjective:
        "Recognize how visual contrast, target shape, target movement, environmental conditions, and empty-field myopia limit the ability to perceive objects in the visual field",
    },

    {
      ...
      difficulty: "high",
      question:
        "What is the correct immediate action upon laser exposure during flight?",
      options: [
        "Close your eyes until the laser exposure stops completely",
        "Look directly at the laser to identify its source location",
        "Look away from beam, shield eyes, place aircraft in safe attitude using instruments if necessary",
        "Continue flying normally and report after landing as usual",
      ],
      correctAnswer: 2,
      explanation:
        "Upon laser exposure: look away from the beam, shield your eyes if possible, and place the aircraft in a safe attitude using instruments if necessary. Do not rub your eyes. Notify ATC and other crewmembers. Laser exposure can cause flash blindness, afterimages, glare, and potential retinal damage. After landing, report the exposure and undergo medical evaluation.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Identify the correct procedures to take upon exposure to lasers in-flight",
    },
    ...
    // AP106/107 - Night Vision and Situational Awareness Questions
    {
      ...
      difficulty: "medium",
      question:
        "How long does it take to achieve full dark adaptation, and how easily is it lost?",
      options: [
        "5-10 min to adapt; lost in seconds with bright light exposure",
        "30 min to adapt; lost in 1-2 min with bright light exposure",
        "30-45 min to adapt; lost in seconds with bright light exposure",
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "Autokinesis is the illusion that a stationary point of light (like a star or distant aircraft light) appears to move when stared at for several seconds in darkness. It's caused by small eye movements and lack of reference points. Prevent it by not staring at a single point, shifting gaze to include other objects, using peripheral vision, and referencing other lights or the horizon.",
      limitation: false,
      objectiveType: "demonstrate",
      learningObjective:
        "Demonstrate methods used to prevent the autokinesis illusion",
    },

    {
      ...
      difficulty: "medium",
      question:
        "According to the Air Force definition, what is Situational Awareness in flying?",
      options: [
        "The ability to fly using instruments only",
        "Knowing the location of other aircraft in airspace",
        "Pilot comprehension of aircraft position, velocity, and attitude relative to mission goals and threats",
        "Awareness of fuel and weather conditions",
      ],
      correctAnswer: 2,
      explanation:
        "Per AFI 11-290, Situational Awareness in flying refers to pilot comprehension of the relationship of the aircraft's position, velocity, and attitude relative to mission goals and threats. It includes perception of environmental elements, comprehension of their meaning, and projection of their future status. Loss of SA is a primary or contributing factor in most human performance-related mishaps.",
      limitation: false,
      objectiveType: "recall",
...

    {
      ...
      options: [
        "Awareness, Understanding, Action model",
        "Perception, Comprehension, Projection model",
        "See, Think, Do model",
        "Detection, Recognition, Response model",
      ],
      correctAnswer: 1,
      explanation:
        "Endsley's SA model has three levels: Level 1 - Perception of elements in the environment; Level 2 - Comprehension of their meaning and significance; Level 3 - Projection of their future status. Understanding these levels helps identify where SA breakdown occurs and how to improve SA during flight operations.",
      limitation: false,
...

    {
      ...
      difficulty: "high",
      question:
        "What is the predominant cause of loss of situational awareness (LSA)?",
      options: [
      ...
      objectiveType: "identify",
      learningObjective:
        "Identify the predominant causes of the loss of situational awareness (LSA)",
    },
    ...
    // AP108 - Spatial Disorientation Questions
    {
      ...
      difficulty: "medium",
      question:
        "Which sensory system provides the strongest and usually most reliable orientation information?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "The visual system provides the strongest and usually most reliable orientation information, accounting for 80% or more of orientation input. However, visual illusions can occur. The vestibular system (inner ear) provides motion and position sense but can be fooled. The somatosensory system is unreliable in flight due to lack of pressure cues. This is why we 'believe the instruments' when sensory systems conflict.",
      limitation: false,
      objectiveType: "select",
      learningObjective:
        "Select the sensory system providing the strongest, and usually the most reliable, orientation information",
    },

    {
      ...
      difficulty: "medium",
      question:
        "What are the two subsystems of the vestibular system and what does each detect?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "The vestibular system has two subsystems: (1) Semicircular canals (three fluid-filled canals oriented in three planes) detect angular acceleration/rotation, and (2) Otolith organs (utricle and saccule) detect linear acceleration and gravity. These systems can be fooled during flight, causing spatial disorientation illusions.",
      limitation: false,
      objectiveType: "define",
      learningObjective:
        "Define the relationship of the vestibular system and the two subsystems: semicircular canals and the otolith organs",
    },
...

    {
      ...
      difficulty: "critical",
      question:
        "What are the most effective methods to prevent spatial disorientation? (Select the most complete answer)",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "SD prevention methods include: (1) Trust and believe your instruments, (2) Maintain instrument flying proficiency, (3) Avoid unnecessary head movements during turns especially in IMC, (4) Understand SD illusions and recognize when susceptible, (5) Maintain proper visual scanning, (6) Ensure adequate rest and avoid self-imposed stresses, (7) Know and practice recovery procedures. Never trust your senses over instruments when they conflict.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
        "Recall 5 methods used to prevent spatial disorientation",
    },
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "The sensory conflict theory is most widely accepted - motion sickness occurs when there's a mismatch between what the visual system sees, what the vestibular system senses, and what the somatosensory system feels. Prevention/treatment includes: focusing on horizon/external references, avoiding unnecessary head movements, adequate ventilation, avoiding heavy meals before flight, and gradual exposure to increase tolerance.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Identify the most widely accepted theory of the cause for motion sickness",
    },
    ...
    // AP110 - Noise and Vibration Questions
    {
      ...
      difficulty: "medium",
      question:
        "What three characteristics of noise affect hearing and potential damage?",
      options: [
      ...
      correctAnswer: 0,
      explanation:
        "The three characteristics affecting hearing are: (1) Frequency - measured in Hertz (Hz), the human ear detects 20-20,000 Hz, (2) Intensity - measured in decibels (dB), sound pressure level, and (3) Duration - length of exposure time. All three factors determine the potential for hearing damage. High intensity noise above 85 dB for extended duration causes permanent hearing loss.",
      limitation: false,
      objectiveType: "list",
      learningObjective:
        "List the characteristics of noises that affect hearing",
    },

    {
      ...
      difficulty: "high",
      question:
        "What are the two types of hearing loss associated with high intensity noise exposure?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "The two types are: (1) Temporary Threshold Shift (TTS) - temporary reduction in hearing sensitivity that recovers with rest (usually 16 hours), and (2) Permanent Threshold Shift (PTS) - permanent hearing damage from prolonged exposure or extremely intense noise. Repeated TTS exposures can lead to cumulative PTS. Proper hearing protection prevents both types.",
      limitation: false,
      objectiveType: "list",
      learningObjective:
        "List types of hearing loss associated with high intensity noise",
    },

    {
      ...
      difficulty: "medium",
      question:
        "What devices help minimize hazardous noise exposure in aviation?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Protective devices include: helmets with integrated communication systems, properly fitted earplugs (foam or custom molded), active noise reduction (ANR) headsets, and proper maintenance of communication equipment. Double hearing protection (earplugs under helmet) may be used for extreme noise. Proper fit and consistent use are critical for effectiveness.",
      limitation: false,
      objectiveType: "list",
...

    {
      ...
      difficulty: "medium",
      question:
        "What are common symptoms of prolonged vibration exposure in aircraft?",
      options: [
    ...
    // AP111 - Acceleration Questions
    {
      ...
      difficulty: "medium",
      question:
        "What are the three types of G-force and their effects on the body?",
      options: [
...

    {
      ...
      difficulty: "high",
      question:
        "What factors determine the effects of G-forces on a crewmember's body?",
      options: [
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "A properly fitted and functioning G-suit provides approximately 1 to 1.5 G of additional protection. It works by inflating bladders that apply external pressure to the legs and lower abdomen, reducing blood pooling in lower extremities during positive Gz. However, the G-suit alone is NOT sufficient - the AGSM must still be performed. The combination of G-suit and AGSM provides maximum protection.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
    ...
    // AP112 - Performance Threats Management Questions
    {
      ...
      difficulty: "critical",
      question:
        "What is the Air Force policy concerning alcohol consumption by crewmembers before flight?",
      options: [
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "Acute fatigue results from a single period of inadequate rest or sustained activity and can be relieved by one period of proper sleep (8+ hours). Chronic fatigue accumulates over time from repeated inadequate rest, sustained operations, or continuous stress. It requires extended recovery (multiple days/weeks). Both impair judgment, reaction time, and decision-making. Chronic fatigue is insidious and may not be recognized by the affected individual.",
      limitation: false,
      objectiveType: "recall",
...

    {
      ...
      objectiveType: "recognize",
      learningObjective:
        "Recognize hypercaffeination effects, post-usage and withdrawal threats",
    },
...

    {
      ...
      difficulty: "high",
      question:
        "What physiological effects does smoking/tobacco use have on aircrew?",
      options: [
    ...
    // AP113 - Oxygen Equipment Questions
    {
      ...
      difficulty: "medium",
      question:
        "What are the two types of oxygen delivery systems used in aircraft?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "The two oxygen delivery systems are: (1) Continuous flow - oxygen flows continuously at a constant rate (used in some older aircraft and emergency systems), wasteful but simple, and (2) Diluter demand/Pressure demand - delivers oxygen only on inhalation, mixes with air at lower altitudes, provides pressure breathing at high altitudes. Most modern military aircraft use pressure demand regulators for efficiency.",
      limitation: false,
      objectiveType: "describe",
      learningObjective:
        "Describe the characteristics of the two types of oxygen delivery systems",
    },

    {
      ...
      difficulty: "medium",
      question:
        "What is the primary advantage of the On-Board Oxygen Generating System (OBOGS) compared to stored oxygen systems?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What is the definition of Human Factors according to the Civil Aviation Authority?",
      options: [
      ...
      correctAnswer: 0,
      explanation:
        "The Civil Aviation Authority defines Human Factors as concerned to optimize the relationship between people and their activities, by the systematic application of human sciences, integrated within the framework of systems engineering. Human factors in aviation has its roots in the earliest days of aviation and accounts for 60-80% of aircraft accidents.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
        "Know basic information about the science of HF and its role in aviation",
    },

    {
      ...
      difficulty: "medium",
      question:
        "Which of the following is NOT a primary function of Earth's atmosphere?",
      options: [
      ...
      correctAnswer: 2,
      explanation:
        "The atmosphere provides oxygen essential for life, absorbs harmful electromagnetic radiation, shields from solar wind and space debris, and contains precipitation to maintain temperature and climate. It does not create artificial gravity - aircraft are bound to Earth by natural gravity.",
      limitation: false,
      objectiveType: "recognize",
...

    {
      ...
      difficulty: "medium",
      question:
        "Atmospheric pressure can be measured in all of the following units EXCEPT:",
      options: [
      ...
      correctAnswer: 3,
      explanation:
        "Atmospheric pressure is measured in psi, mmHg, or inHg. Celsius per thousand feet is a unit for temperature lapse rate, not pressure. Atmospheric pressure readings vary daily depending on changing surface temperatures, humidity, and high/low pressure weather fronts.",
      limitation: false,
      objectiveType: "recall",
      learningObjective: "Know the characteristics of the earth's atmosphere",
    },

    {
      ...
      difficulty: "medium",
      question:
        "What are the standard pressure and temperature values at sea level for the U.S. Standard Atmosphere?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "The heart functions as how many pumps, and what are their purposes?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "The heart consists of four chambers but functions as two pumps in series - one to propel blood through the lungs for gas exchange (pulmonary circulation) and one to drive blood to all other tissues of the body (systemic circulation). Unidirectional flow is achieved by an arrangement of flap-like valves.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
        "Know the structures and functions of the circulatory system",
    },
...

    {
      ...
      difficulty: "high",
      question:
        "Which of the following factors does NOT directly influence the development of hypoxic hypoxia?",
      options: [
...

    {
      ...
      difficulty: "critical",
      question:
        "Which signs and symptoms are most often observed in hypocapnia?",
      options: [
...

    {
      ...
      difficulty: "critical",
      question:
        "What is the correct T-6 treatment procedure sequence for suspected hypocapnia?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Since physiological symptoms (hypocapnia, hypoxia) may be confused or occur simultaneously, ALL physiological symptoms are treated the same. T-6 procedures: 1) Green Ring - Pull, 2) Descent below 10,000 feet MSL, 3) OBOGS SUPPLY LEVER - OFF, 4) Check emergency O2 hose, 5) Rate and depth of breathing - Normalize. This treats all physiological symptoms simultaneously without delay.",
      limitation: false,
      objectiveType: "memorize",
      learningObjective: "Know the characteristics of hypocapnia",
    },
...

    {
      ...
      difficulty: "high",
      question:
        "Which of the following are the four main types of trapped gas disorders?",
      options: [
...

    {
      ...
      difficulty: "high",
      question:
        "A pilot experiences severe pain in the upper teeth during descent. What is the most likely cause?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Blockage of ducts leading to the maxillary sinuses (located in the bones of the cheeks beneath the eyes) may be mistaken for upper tooth pain because of their proximity to the upper teeth. All of the upper teeth will be affected as opposed to one isolated tooth. This should be treated like any other sinus block using the Valsalva maneuver.",
      limitation: false,
      objectiveType: "recall",
      learningObjective: "Know the characteristics of trapped gas disorders",
    },

    {
      ...
      difficulty: "critical",
      question:
        "What are the immediate corrective actions for suspected decompression sickness?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "For any type of DCS, immediate descent is mandatory. Descent below the altitude of occurrence will usually decrease or resolve symptoms. Continued descent is required even if pain completely resolves on initial descent. Increasing the total barometric pressure on the body is the only effective means of eliminating DCS. Breathing 100% oxygen at altitude will not normally resolve the pain.",
      limitation: false,
      objectiveType: "recall",
...

    {
      ...
      difficulty: "high",
      question:
        "What methods are used to treat decompression sickness after landing?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "Which type of pressurization system is commonly used in modern military aircraft?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Modern military aircraft commonly use bleed air from engine compressor sections for cabin pressurization. This system takes compressed air from the engine, cools it, and regulates it to maintain desired cabin altitude. This protects against hypoxia and DCS by keeping the body below 25,000 feet cabin altitude under normal operations.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Know how aircraft pressurization affects aircrew members",
    },

    {
      ...
      difficulty: "critical",
      question:
        "What are the immediate procedures for dealing with rapid decompression in the T-6?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "Which part of the eye contains the photoreceptors (rods and cones) responsible for vision?",
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the primary characteristics that distinguish focal vision from peripheral vision?",
      options: [
      ...
      correctAnswer: 0,
      explanation:
        "Focal vision uses the central 3° of the visual field for high acuity and detail work, relying primarily on cones in the fovea. Peripheral vision uses the remaining visual field (up to 150° total) and is better for detecting motion and objects in dim light, relying more on rods. Focal vision provides best acuity and reaction time during daylight (photopic vision).",
      limitation: false,
      objectiveType: "identify",
...

    {
      ...
      difficulty: "medium",
      question:
        "What is a key limitation of focal vision that affects aircraft operations?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Focal vision's key limitation is its very narrow field of view - only the central 3° provides high acuity. This requires constant head and eye movement to scan the environment effectively. Peripheral vision limitations include reduced acuity and detail, but better motion detection. Both systems have blind spots approximately 30° right of center due to the optic nerve.",
      limitation: true,
      objectiveType: "identify",
      learningObjective: "Know the characteristics of visual field",
    },

    {
      ...
      difficulty: "high",
      question:
        "How do perception/reaction time and visual acquisition affect midair collision avoidance?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Perception-reaction time is the delay between seeing an object and reacting to it. Combined with visual acquisition limitations (ability to detect and identify objects), this can mean an aircraft is not detected until dangerously close. Factors affecting this include visual contrast, target shape, target movement, environmental conditions, and empty-field myopia. Proper scanning technique is essential for midair collision avoidance.",
      limitation: true,
      objectiveType: "identify",
      learningObjective:
        "Know the limitations and visual illusions associated with daytime flight",
    },

    {
      ...
      difficulty: "high",
      question:
        "Which of the following is a common daytime visual illusion encountered in aviation?",
      options: [
...

    {
      ...
      difficulty: "high",
      question:
        "Which factors contribute to daytime visual illusions in flight?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Factors involved in daytime visual illusions include: visual contrast (object vs background), target shape and size, target movement (or lack thereof), environmental conditions (weather, lighting, terrain), and empty-field myopia (eyes relaxing to intermediate focus when no objects to focus on). These factors can limit the ability to perceive objects correctly in the visual field.",
      limitation: true,
      objectiveType: "recall",
      learningObjective:
        "Know the limitations and visual illusions associated with daytime flight",
...

    {
      ...
      difficulty: "medium",
      question:
        "Which techniques can maximize visual acuity during flight operations?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Techniques to maximize visual acuity include: using proper scanning technique (series of short eye movements), ensuring adequate oxygen supply, maintaining physical fitness, protecting eyes from excessive bright light exposure, allowing proper dark adaptation time, avoiding self-imposed stressors (fatigue, hypoglycemia, dehydration), and proper use of corrective lenses if needed.",
      limitation: false,
      objectiveType: "recall",
      learningObjective:
        "Select measures you can take to ensure maximum visual acuity in both day and night flying conditions",
    },
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the primary hazards associated with laser exposures during flight?",
      options: [
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "Flash blindness occurs when intense light temporarily bleaches the rhodopsin (visual purple) in rod cells, which are responsible for night vision. This destroys the dark adaptation that took 30+ minutes to develop. Recovery can take another 30 minutes or more depending on the intensity and duration of light exposure. Even brief exposure to bright light can significantly compromise night vision capability.",
      limitation: true,
      objectiveType: "identify",
...

    {
      ...
      difficulty: "medium",
      question:
        "What visual capabilities are reduced during night vision operations?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the two primary types of information processing used in situational awareness?",
      options: [
...

    {
      ...
      difficulty: "high",
      question:
        "Which attention management limitation has the greatest impact on situational awareness?",
      options: [
      ...
      objectiveType: "identify",
      learningObjective:
        "Comprehend the causes of a loss of situational awareness",
    },

    {
      ...
      difficulty: "medium",
      question:
        "Which methods are most effective for improving SA and attention management?",
      options: [
...

    {
      ...
      difficulty: "high",
      question:
        "What are key cues for recognizing a loss of situational awareness?",
      options: [
...

    {
      ...
      difficulty: "high",
      question:
        "What are effective mechanisms to recover from loss of situational awareness?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "How do attention management failures contribute to aviation mishaps?",
      options: [
...

    {
      ...
      difficulty: "high",
      question:
        "What are the three main types of spatial disorientation and their impacts?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the four sensory systems used in spatial orientation?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What structures comprise the vestibular system and what is their function?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "Why is the somatosensory system unreliable for orientation during flight?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "Which environmental factors increase the risk of spatial disorientation?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What physiological factors increase susceptibility to spatial disorientation?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What techniques help prevent and/or treat motion sickness in flight?",
      options: [
      ...
      objectiveType: "identify",
      learningObjective:
        "Know the causes of and techniques to prevent/overcome motion sickness in flight",
    },
...

    {
      ...
      difficulty: "medium",
      question:
        "How is hazardous noise defined in the context of aviation physiology?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the units of measure for frequency, intensity, and duration of noise?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the potential nonauditory effects of noise on crewmember in-flight performance?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What techniques help minimize hazardous noise exposure beyond wearing hearing protection devices?",
      options: [
      ...
      objectiveType: "describe",
      learningObjective:
        "Know the protective measures used to minimize hazardous noise exposure",
    },
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the three types of acceleration that affect the human body?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "The three types of acceleration are: 1) Linear acceleration - change in velocity in a straight line (takeoff, landing, thrust changes), 2) Radial/centrifugal acceleration - change in direction while maintaining speed (turns, creating outward force), and 3) Angular/rotational acceleration - change in rate of rotation (affects the vestibular system, causes somatogyral illusions). All three can occur in combination during flight maneuvers.",
      limitation: false,
      objectiveType: "identify",
      learningObjective:
        "Know the characteristics of acceleration and G forces",
    },
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "The four principle physiological effects of G forces are: 1) Cardiovascular - blood pooling and reduced cardiac output, 2) Pulmonary - difficulty breathing and reduced lung expansion under high G, 3) Musculoskeletal - body weight increase making movement difficult, and 4) Visual - reduced blood flow to eyes causing progressive vision loss. Associated symptoms range from mild discomfort to incapacitation depending on G magnitude and duration.",
      limitation: true,
      objectiveType: "identify",
      learningObjective:
        "Know the characteristics of the factors that determine the effects of G forces on a crewmember's body",
    },
...

    {
      ...
      difficulty: "high",
      question:
        "What methods can increase a crewmember's tolerance to positive G-forces?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Methods to increase G tolerance include: proper Anti-G Straining Maneuver (AGSM) technique, wearing properly fitted G-suit (+1 to 1.5G protection), maintaining cardiovascular fitness, proper hydration (dehydration reduces tolerance), adequate rest (fatigue decreases tolerance), avoiding self-imposed stressors (alcohol, poor nutrition), gradual G onset when possible, experience and training to improve AGSM technique, and proper body position in seat.",
      limitation: false,
      objectiveType: "identify",
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "Self-imposed stressors significantly decrease G tolerance. Dehydration reduces blood volume and cardiovascular function. Fatigue impairs the ability to perform proper AGSM. Poor nutrition (especially hypoglycemia) reduces physical performance. Alcohol causes dehydration and impairs judgment. Illness, medications, and lack of sleep all degrade physiological reserves. Avoiding these stressors through proper rest, hydration, nutrition, and fitness is essential for maintaining maximum G tolerance.",
      limitation: true,
      objectiveType: "recognize",
      learningObjective:
        "Know the characteristics of the methods used to increase a crewmember's tolerance to positive G-forces",
    },
...

    {
      ...
      correctAnswer: 1,
      explanation:
        "OTC medications that pose risks include: antihistamines (cause drowsiness, impair performance), decongestants (affect blood pressure and heart rate), pain relievers (some cause drowsiness), sleep aids (long-lasting sedation), stimulants (affect judgment), and anti-diarrheal medications. Nutritional supplements may also contain banned or performance-impairing substances. Air Force policy requires flight surgeon approval before using any medication.",
      limitation: true,
      objectiveType: "identify",
      learningObjective:
        "Know the aircrew performance effects of over-the-counter medications and nutritional supplements",
    },
...

    {
      ...
      difficulty: "medium",
      question:
        "What are effective methods to prevent hypoglycemia during flight operations?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What methods effectively prevent dehydration during flight operations?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the advantages and disadvantages of GO/NO-GO Pill usage?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What constitutes strategic caffeine consumption tactics for optimal performance?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What countermeasures help manage thermal stress during flight operations?",
      options: [
      ...
      objectiveType: "recall",
      learningObjective:
        "Know the aircrew performance effects of thermal stress",
    },

    {
      ...
      difficulty: "medium",
      question:
        "What stress countermeasures and stress management methods are effective for aircrew?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Stress management methods include: maintain physical fitness (reduces stress response), ensure adequate sleep and rest, effective time management to reduce overload, maintain social support networks, mental preparation and visualization, recognize early stress signs (irritability, difficulty concentrating), compartmentalize stressors when possible, seek professional help when needed (chaplain, mental health), avoid additional self-imposed stressors, and use proper workload management techniques. Chronic unmanaged stress significantly degrades performance and increases mishap risk.",
      limitation: false,
      objectiveType: "recall",
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the operational and emergency ceilings of a pressure demand regulator?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What are the component parts of emergency oxygen systems in the T-6?",
      options: [
...

    {
      ...
      difficulty: "medium",
      question:
        "What procedures ensure proper care of the oxygen mask and helmet?",
      options: [
...
export function getAllAerospacePhysiologyQuestions() {
  return [
    ...aerospacePhysiologyQuestions.multipleChoice.map((q) => ({
      ...q,
