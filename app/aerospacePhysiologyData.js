...
export const aerospacePhysiologyQuestions = {
  ...
  multipleChoice: [
    // ATMOSPHERE
    {
      ...
      correctAnswer: 1,
      explanation:
        "Oxygen makes up approximately 21% of the atmosphere at sea level. Nitrogen comprises 78%, and other gases make up the remaining 1%. This percentage remains constant with altitude, but the partial pressure of oxygen decreases as you climb, which is why supplemental oxygen is required at higher altitudes.",
      limitation: false,
    ...
    },
    {
      ...
      difficulty: "high",
      question:
        "At what altitude does atmospheric pressure drop to approximately 50% of sea level pressure?",
    ...
    // RESPIRATION AND HYPOXIA
    {
      ...
      difficulty: "critical",
      question:
        "Which type of hypoxia is most common in aviation and is caused by insufficient oxygen in the air?",
      options: [
        "Hypemic hypoxia",
        "Histotoxic hypoxia",
        "Hypoxic hypoxia",
      ...
      correctAnswer: 2,
      explanation:
        "Hypoxic hypoxia (altitude hypoxia) is the most common type in aviation. It occurs when there is insufficient oxygen in the air being breathed, typically at high altitudes. Other types include: Hypemic (blood can't carry oxygen, e.g., CO poisoning), Histotoxic (cells can't use oxygen, e.g., alcohol/drugs), and Stagnant (poor circulation). Recognition of symptoms is critical for flight safety.",
      limitation: false,
      objectiveType: "identify",
    ...
    },
    {
      ...
      difficulty: "high",
      question:
        "What is the Time of Useful Consciousness (TUC) at 25,000 feet without supplemental oxygen?",
      options: ["30 seconds", "1-2 minutes", "3-5 minutes", "10-15 minutes"],
      correctAnswer: 2,
      explanation:
        "At 25,000 feet, the TUC is approximately 3-5 minutes. TUC is the time period from the interruption of oxygen supply until the pilot is unable to perform tasks requiring normal cognitive function. This varies by altitude: 18,000 ft = 20-30 min, 25,000 ft = 3-5 min, 30,000 ft = 1-2 min, 40,000 ft = 15-20 sec. Understanding TUC is critical for emergency response to oxygen system failures.",
      limitation: true,
      objectiveType: "identify",
      learningObjective:
        "Identify Time of Useful Consciousness at various altitudes",
    },
    ...
    // TRAPPED GAS
    {
      ...
      difficulty: "medium",
      question:
        "According to Boyle's Law, when you climb from sea level to 18,000 feet, trapped gas in body cavities will:",
      options: [
    ...
    // DECOMPRESSION SICKNESS
    {
      ...
      difficulty: "high",
      question:
        "What is the minimum altitude at which decompression sickness (DCS) can occur?",
      ...
      objectiveType: "identify",
      learningObjective:
        "Identify conditions that lead to decompression sickness",
    },
    ...
    // SPATIAL DISORIENTATION
    {
      ...
      correctAnswer: 1,
      explanation:
        "Spatial disorientation occurs when the vestibular system (inner ear) sends false signals about the aircraft's attitude and motion, conflicting with what instruments show. The vestibular system evolved for slow movements on the ground, not for the speeds and accelerations of flight. In IMC or at night, you must trust your instruments. The famous saying: 'Your body lies, your instruments don't.' Types include: the leans, graveyard spiral, Coriolis illusion.",
      limitation: false,
  ...
  trueFalse: [
    {
      ...
      difficulty: "high",
      question:
        "Hyperventilation symptoms are similar to hypoxia symptoms and include dizziness, tingling, and visual disturbances.",
      correctAnswer: true,
      explanation:
        "TRUE. Hyperventilation (excessive breathing rate) causes too much CO2 to be expelled from the blood, leading to symptoms that mimic hypoxia: dizziness, lightheadedness, tingling in extremities, visual disturbances, and anxiety. The key difference: hyperventilation is often associated with rapid breathing and anxiety, while hypoxia is associated with altitude. Treatment for hyperventilation: slow breathing rate, breathe into a bag if available, or talk yourself through calming down.",
      limitation: false,
      objectiveType: "recognize",
    ...
    },
    {
      ...
      difficulty: "medium",
      question:
        "Empty field myopia occurs when there are no visual references, causing the eyes to focus at approximately 10-30 feet.",
      correctAnswer: true,
      explanation:
        "TRUE. Empty field myopia is a condition where, in the absence of visual references (such as flying in haze, clouds, or at night over water), the eyes naturally relax and focus at a close distance (10-30 feet). This can prevent you from seeing other aircraft or terrain. Prevention: frequently scan the entire visual field, use instruments, and actively focus at different distances to keep your eyes actively accommodating.",
      limitation: false,
      objectiveType: "define",
  ...
  reorderSequence: [
    {
      ...
      explanation:
        "The immediate response to hypoxia is critical: (1) Recognize you have a problem - this is the hardest step due to impaired judgment, (2) Get 100% oxygen immediately, (3) Descend to a safe altitude, (4) Verify equipment is working, (5) Monitor recovery. Time is critical - at high altitudes you may only have seconds to respond. This is why recognizing your personal hypoxia symptoms (from altitude chamber training) is so important.",
      limitation: false,
    ...
    },
    {
      ...
      explanation:
        "Proper night vision preparation is essential: (1) Avoid bright lights 30 min before flight, (2) Use red lights (least disruptive to dark adaptation), (3) Allow full 30 minutes for adaptation, (4) Use off-center viewing (rods are concentrated off-center), (5) Avoid smoking and hypoxia which reduce night vision capability. Remember: bright light exposure will instantly reset the adaptation process.",
      limitation: false,
      objectiveType: "list",
...
export function getAllAerospacePhysiologyQuestions() {
  return [
    ...
    ...aerospacePhysiologyQuestions.trueFalse.map((q) => ({
      ...q,
      questionType: "trueFalse",
    })),
    ...aerospacePhysiologyQuestions.reorderSequence.map((q) => ({
      ...q,
