...
export const aerospacePhysiologyQuestions = {
  multipleChoice: [
    ...
    },
    {
      id: "ap-mc-072",
      category: "AP 103 - Altitude Threats",
      topic: "Hypemic Hypoxia",
      difficulty: "medium",
      question: "What is the primary cause of hypemic hypoxia in aviation?",
      options: [
        "Carbon monoxide poisoning from smoking or exhaust fumes binding to hemoglobin",
        "Reduced atmospheric oxygen pressure at high altitude during flight operations",
        "Blood pooling in lower extremities during sustained positive G-force maneuvers",
        "Alcohol or drug consumption preventing cellular oxygen utilization in tissues",
      ],
      correctAnswer: 0,
      explanation:
        "Hypemic hypoxia is caused by reduced oxygen carrying capacity of blood. Carbon monoxide (CO) from smoking or exhaust has 200-250x greater affinity for hemoglobin than oxygen, reducing available hemoglobin for oxygen transport. Anemia and blood loss also cause hypemic hypoxia.",
      limitation: false,
    },
    {
      id: "ap-mc-073",
      category: "AP 103 - Altitude Threats",
      topic: "Stagnant Hypoxia",
      difficulty: "hard",
      question: "Which aviation scenarios can cause stagnant hypoxia?",
      options: [
        "Sustained G-forces causing blood pooling, cold exposure with vasoconstriction, heart failure reducing cardiac output",
        "High altitude flight above 10,000 feet reducing atmospheric oxygen partial pressure significantly",
        "Alcohol consumption before flight impairing cellular ability to utilize oxygen molecules",
        "Carbon monoxide from engine exhaust or smoking reducing hemoglobin oxygen carrying capacity",
      ],
      correctAnswer: 0,
      explanation:
        "Stagnant hypoxia results from inadequate blood circulation to tissues. Causes include: (1) Sustained G-forces causing blood pooling in lower body, (2) Cold exposure causing vasoconstriction, (3) Heart failure or shock reducing cardiac output. Adequate oxygen is present but cannot reach tissues.",
      limitation: false,
    },
    {
      id: "ap-mc-074",
      ...
      difficulty: "medium",
      question: "What causes histotoxic hypoxia in aircrew members?",
      options: [
        "Alcohol, drugs, or toxins (cyanide) preventing cells from utilizing available oxygen",
        "Reduced partial pressure of oxygen in inspired air at high altitude flight",
        "Carbon monoxide binding to hemoglobin reducing oxygen carrying capacity of blood",
        "Positive G-forces causing blood pooling and inadequate circulation to brain",
      ],
      correctAnswer: 0,
      explanation:
        "Histotoxic hypoxia occurs when cells cannot utilize available oxygen despite adequate delivery. Primary causes: alcohol (even small amounts), narcotics, certain drugs, and toxins like cyanide. Oxygen and circulation are normal but cellular metabolism is impaired.",
      limitation: false,
    },
    {
      id: "ap-mc-075",
      category: "AP 105 - Acceleration",
      topic: "G-Force Basics",
      difficulty: "medium",
      question: "What is the correct definition of G-force in aviation?",
      options: [
        "The force of gravity or acceleration expressed as multiples of standard gravitational force (1G = 32.2 ft/sec²)",
        "The maximum centrifugal force experienced during high-speed turning maneuvers in aircraft",
        "The total weight of aircraft and occupants measured in pounds during flight operations",
        "The rate of altitude change during climb or descent expressed in feet per minute",
      ],
      correctAnswer: 0,
      explanation:
        "G-force is the force of gravity or acceleration expressed as multiples of standard gravitational acceleration. 1G equals 32.2 ft/sec² (Earth's gravity). +Gz points head-to-foot (positive G), -Gz points foot-to-head (negative G), ±Gx is fore/aft, ±Gy is lateral.",
      limitation: false,
    },
    {
      id: "ap-mc-076",
      category: "AP 105 - Acceleration",
      topic: "Positive G Effects",
      difficulty: "hard",
      question:
        "What is the correct sequence of G-induced visual symptoms during sustained positive G?",
      options: [
        "Grey-out (loss of peripheral vision), Tunnel vision (loss of peripheral + color), Blackout (complete vision loss)",
        "Blackout (immediate total vision loss), Red-out (blood in retina), Unconsciousness (G-LOC)",
        "Blurred vision (slight impairment), Double vision (diplopia), Tunnel vision (central only)",
        "Tunnel vision (central only), Grey-out (reduced brightness), Blackout (complete loss)",
      ],
      correctAnswer: 0,
      explanation:
        "Positive G visual symptoms progress: (1) Grey-out at ~4-5G - loss of peripheral vision, decreased brightness, (2) Tunnel vision at ~5-6G - loss of peripheral + color vision, (3) Blackout at ~6-7G - complete vision loss while conscious, (4) G-LOC - unconsciousness. Individual tolerance varies significantly.",
      limitation: false,
    },
    {
      id: "ap-mc-077",
      ...
      difficulty: "critical",
      question:
        "What is G-induced Loss of Consciousness (G-LOC) and when does it typically occur?",
      options: [
        "Complete unconsciousness from inadequate blood flow to brain, typically at 6-7+ sustained G in unprotected pilot",
        "Temporary disorientation and confusion from rapid onset G-forces during aerobatic maneuvers only",
        "Loss of peripheral vision and color perception occurring at 4-5G during sustained turns",
        "Reduced cognitive function and reaction time from hypoxia at altitudes above 18,000 feet",
      ],
      correctAnswer: 0,
      explanation:
        "G-LOC (G-induced Loss of Consciousness) occurs when sustained positive G (typically 6-7+G in unprotected pilot) causes blood pooling in lower body, reducing cerebral blood flow below critical level. Results in complete unconsciousness for 10-20 seconds. Prevented by: Anti-G straining maneuver (AGSM), G-suit, physical fitness.",
      limitation: false,
    },
    {
      id: "ap-mc-078",
      category: "AP 105 - Acceleration",
      topic: "Anti-G Straining Maneuver",
      difficulty: "critical",
      question:
        "What is the correct Anti-G Straining Maneuver (AGSM) technique?",
      options: [
        "Tense lower body muscles, 3-second strain and grunt exhale, quick inhale, repeat continuously during G",
        "Hold breath for maximum duration, perform Valsalva maneuver, exhale slowly through pursed lips",
        "Deep breathing hyperventilation before maneuver, relax all muscles, exhale during peak G",
        "Rapid shallow breathing pattern, tense upper body only, maintain throughout entire maneuver",
      ],
      correctAnswer: 0,
      explanation:
        "Correct AGSM (L-1): (1) Tense legs, buttocks, abdomen, (2) Strain and grunt exhale for 3 seconds, (3) Quick inhale, (4) Repeat continuously during G exposure. Increases G tolerance by ~3-4G. Must be combined with proper G-suit for maximum effectiveness. Never hold breath continuously.",
      limitation: false,
    },
    {
      id: "ap-mc-079",
      category: "AP 105 - Acceleration",
      topic: "Negative G Effects",
      difficulty: "medium",
      question: "What symptoms occur during negative G (pushover) maneuvers?",
      options: [
        "Red-out (blood rushes to head causing red vision), facial congestion, bulging eyes, severe headache",
        "Grey-out (loss of peripheral vision), tunnel vision, progressive blackout of visual field",
        "Numbness and tingling in extremities, cold sweats, nausea and disorientation",
        "Chest pain, difficulty breathing, cyanosis (blue skin), loss of consciousness",
      ],
      correctAnswer: 0,
      explanation:
        "Negative G (-Gz) causes blood to rush toward head. Symptoms: red-out (red vision from blood in retina), facial congestion, bulging eyes, severe headache, possible broken blood vessels. Much more uncomfortable than positive G and poorly tolerated. Humans can tolerate only -2 to -3G vs +9G with protection.",
      limitation: false,
    },
    {
      id: "ap-mc-080",
      category: "AP 105 - Acceleration",
      topic: "G-Force and Hypoxia Relationship",
      difficulty: "hard",
      question: "How do G-forces and altitude combine to affect hypoxia risk?",
      options: [
        "G-forces cause stagnant hypoxia by reducing blood flow; altitude causes hypoxic hypoxia - effects are cumulative and multiplicative",
        "G-forces and altitude are unrelated factors that independently affect pilot performance without interaction",
        "G-forces increase oxygen delivery to brain compensating for reduced PO₂ at altitude",
        "Altitude negates G-force effects by reducing air density and decreasing aerodynamic forces on body",
      ],
      correctAnswer: 0,
      explanation:
